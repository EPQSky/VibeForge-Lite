...
| 顺序执行 | `$execute-spec-tickets` | 按依赖逐票实施、批量发现与整批修复、硬门禁并提交 |
...
发布版可以把 `dist/vibeforge-lite-0.3.7.tar.gz` 作为 release artifact。安装或更新 Plugin 后，新开一个 Codex task 让 skills 重新加载。
